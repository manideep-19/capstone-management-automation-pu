...
export const StudentDashboard: React.FC = () => {
  ...
  const handleInviteMember = () => {
    ...
    const invitedUser = users.find(u => u.email === inviteEmail && u.role === 'student');
    if (!invitedUser) {
      setMessage('Student not found with this email');
      return;
    }
    ...
    setInviteEmail('');
    setMessage(`Invitation sent to ${invitedUser.name}`);
  };
