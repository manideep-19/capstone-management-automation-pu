...
export const initializeMockData = () => {
  if (!localStorage.getItem('users')) {
    const mockUsers: (User & { password: string })[] = [
      ...
      // Add the student from the image
      {
        id: '6',
        email: 'manideep.20221CIT0091@presidencyuniversity.in',
        rollNo: '20221CIT0091',
        name: 'Manideep',
        role: 'student',
        isVerified: true,
      ...
      // Add the student being invited
      {
        id: '7',
        email: 'nehashree.20221CIT0083@presidencyuniversity.in',
        rollNo: '20221CIT0083',
        name: 'Nehashree',
        role: 'student',
        isVerified: true,
      ...
      {
        id: '8',
        email: 'john.2022CSE001@presidencyuniversity.in',
        rollNo: '2022CSE001',
        name: 'John Doe',
        role: 'student',
        isVerified: true,
      ...
      {
        id: '9',
        email: 'sarah.2022IT002@presidencyuniversity.in',
        rollNo: '2022IT002',
        name: 'Sarah Smith',
        role: 'student',
        isVerified: true,
  ...
  if (!localStorage.getItem('projects')) {
    const mockProjects: Project[] = [
      ...
      },
      {
        ...
        specialization: 'Computer Science',
        isAssigned: true, // This one is assigned to the existing team
        createdAt: new Date()
      },
      {
        id: '5',
  ...
  if (!localStorage.getItem('teams')) {
    // Add a sample team for the user in the image
    const mockTeams: Team[] = [
      {
        id: '1',
        name: 'CIT01',
        members: ['6'], // manideep's ID
        leaderId: '6',
        projectId: '4', // Mobile App for Campus Navigation
        status: 'assigned',
        invites: [],
        createdAt: new Date()
      }
